      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold text-green-400 mb-4">FreshGrocer</h3>
              <p className="text-gray-300">
                Your trusted source for fresh groceries delivered to your doorstep.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><a href="#" className="hover:text-green-400 transition-colors">Products</a></li>
